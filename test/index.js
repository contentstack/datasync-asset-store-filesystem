...
describe('# download', function () {
	...
	test('# dowload asset', function () {
		return connector.download({
			...
			"tags": [4],
			"filename": "Widakk.png",
			"url": "https://images.contentstack.io/v3/assets/***REMOVED***/blta8b9d1676a31d361/5c24957dc3cf797d38cca458/cherry-blossom.jpg",
			"is_dir": false,
			"parent_uid": "f1",
			"_version": 1,
			"title": "Widakk.png",
	...
	test('# unpublish non existent asset', function () {
		return connector.unpublish({
			...
			"tags": [4],
			"filename": "abc.png",
			"url": "https://images.contentstack.io/v3/assets/***REMOVED***/blta8b9d1676a31d361/5c24957dc3cf797d38cca458/cherry.jpg",
			"is_dir": false,
			"parent_uid": "f1",
			"_version": 1,
			"title": "Widakk.png",
